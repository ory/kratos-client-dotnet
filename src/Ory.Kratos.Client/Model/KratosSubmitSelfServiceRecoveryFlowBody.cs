...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosSubmitSelfServiceRecoveryFlowBody : AbstractOpenAPISchema, IEquatable<KratosSubmitSelfServiceRecoveryFlowBody>, IValidatableObject
    {
        ...
        /// <summary>
        /// Get the actual instance of `KratosSubmitSelfServiceRecoveryFlowWithLinkMethodBody`. If the actual instanct is not `KratosSubmitSelfServiceRecoveryFlowWithLinkMethodBody`,
