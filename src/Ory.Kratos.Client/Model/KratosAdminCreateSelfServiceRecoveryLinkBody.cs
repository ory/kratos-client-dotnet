...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosAdminCreateSelfServiceRecoveryLinkBody : IEquatable<KratosAdminCreateSelfServiceRecoveryLinkBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KratosAdminCreateSelfServiceRecoveryLinkBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KratosAdminCreateSelfServiceRecoveryLinkBody()
        {
        ...
        public KratosAdminCreateSelfServiceRecoveryLinkBody(string expiresIn = default(string), string identityId = default(string))
        {
            // to ensure "identityId" is required (not null)
            this.IdentityId = identityId ?? throw new ArgumentNullException("identityId is a required property for KratosAdminCreateSelfServiceRecoveryLinkBody and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KratosAdminCreateSelfServiceRecoveryLinkBody {\n");
        ...
        {
            return this.Equals(input as KratosAdminCreateSelfServiceRecoveryLinkBody);
        }

        /// <summary>
        /// Returns true if KratosAdminCreateSelfServiceRecoveryLinkBody instances are equal
        /// </summary>
        /// <param name="input">Instance of KratosAdminCreateSelfServiceRecoveryLinkBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KratosAdminCreateSelfServiceRecoveryLinkBody input)
        {
            if (input == null)
                return false;
