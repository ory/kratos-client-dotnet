...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUiContainer : IEquatable<KratosUiContainer>, IValidatableObject
    {
        ...
        public KratosUiContainer(string action = default(string), List<KratosUiText> messages = default(List<KratosUiText>), string method = default(string), List<KratosUiNode> nodes = default(List<KratosUiNode>))
        {
            ...
            this.Action = action ?? throw new ArgumentNullException("action is a required property for KratosUiContainer and cannot be null");
            // to ensure "method" is required (not null)
            this.Method = method ?? throw new ArgumentNullException("method is a required property for KratosUiContainer and cannot be null");
            // to ensure "nodes" is required (not null)
            this.Nodes = nodes ?? throw new ArgumentNullException("nodes is a required property for KratosUiContainer and cannot be null");
